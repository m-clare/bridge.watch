...
docker tag db-prod registry.digitalocean.com/${DO_REGISTRY}/db-prod
...
docker tag web-prod registry.digitalocean.com/${DO_REGISTRY}/web-prod
...
docker tag express-prod registry.digitalocean.com/${DO_REGISTRY}/express-prod
